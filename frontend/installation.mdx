...
<img alt="Linux is Good" classname="block dark:hidden" src="/images/tech_loops-light.png" />

<img alt="Linux is Good" classname="hidden dark:block" src="/images/tech_loops-dark.png" />
...
# REPLACE 127.0.0.1 WITH THE IP OF THE SERVER WHERE FRONTEND IS INSTALLED
```
