...
```
<Note>
Here, the 1-0 demonicates 1 as **app_id** that needs to be configured in front end and using here it will fetch the congiguration via API. The 0 is the GPU ID that will be used to run the application.
</Note> 